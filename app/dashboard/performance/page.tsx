...
export default function PerformancePage() {
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <Card className="p-5">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="font-bold text-sm text-foreground">Efficiency</h3>
          </div>
        ...
        <Card className="p-5">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="font-bold text-sm text-foreground">Productivity</h3>
          </div>
        ...
        <Card className="p-5">
          ...
          <div className="text-3xl font-bold text-foreground mb-1">1.2s</div>
      ...
      <Card className="p-6">
        <h3 className="text-lg font-bold text-foreground mb-4 border-b border-border/50 pb-2">Operational Trends</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <div className="p-4 bg-background/5/5 rounded-xl border border-border">
            <span className="text-xs text-foreground/70 uppercase tracking-wider font-semibold block mb-1">Daily Output</span>
