  ...
  return (
    <>
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Button className="shrink-0 bg-accent text-white hover:bg-accent/90">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <Card className="p-6 border-l-4 border-l-accent flex flex-col items-start bg-background/5/5">
          ...
          <h3 className="font-bold text-xl text-foreground mb-2">AI Assistant</h3>
      ...
      <Card className="p-6">
        <h3 className="text-lg font-bold text-foreground mb-6 border-b border-border/50 pb-2">Quick Actions & Resources</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <Button variant="ghost" className="h-auto p-4 flex flex-col items-start gap-3 border border-border bg-background/5/5 hover:bg-background/5/10 hover:border-accent/30 rounded-xl transition-all">
            ...
            <div className="text-left">
              ...
              <span className="text-xs text-foreground/70 font-normal">Learn the basics</span>
            </div>
          </Button>
          ...
          <Button variant="ghost" className="h-auto p-4 flex flex-col items-start gap-3 border border-border bg-background/5/5 hover:bg-background/5/10 hover:border-accent/30 rounded-xl transition-all">
            ...
            <div className="text-left">
              ...
              <span className="text-xs text-foreground/70 font-normal">Technical integration</span>
            </div>
          </Button>
          ...
          <Button variant="ghost" className="h-auto p-4 flex flex-col items-start gap-3 border border-border bg-background/5/5 hover:bg-background/5/10 hover:border-accent/30 rounded-xl transition-all">
            ...
            <div className="text-left">
              ...
              <span className="text-xs text-foreground/70 font-normal">Talk to a human</span>
            </div>
          </Button>

          <Button variant="ghost" className="h-auto p-4 flex flex-col items-start gap-3 border border-border bg-background/5/5 hover:bg-background/5/10 hover:border-red-300 rounded-xl transition-all">
            <div className="p-2 bg-background/5 rounded-lg shadow-sm">
              <HelpCircle className="w-5 h-5 text-red-500" />
            </div>
            <div className="text-left">
              <span className="text-sm font-bold block mb-1 text-red-600">Report Issue</span>
              <span className="text-xs text-foreground/70 font-normal">File a bug report</span>
            </div>
          </Button>
        </div>
      </Card>
