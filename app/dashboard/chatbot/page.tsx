  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <Card className="p-6 border-l-4 border-l-accent flex flex-col items-start bg-white/5/5">
        ...
        <Card className="p-6 border-l-4 border-l-blue-500 flex flex-col items-start bg-white/5/5">
          ...
          <Button variant="outline" className="mt-auto w-full sm:w-auto font-medium bg-white/5">Browse Help <ArrowRight className="w-4 h-4 ml-2" /></Button>
        </Card>
      </div>
      ...
      <Card className="p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <Button variant="ghost" className="h-auto p-4 flex flex-col items-start gap-3 border border-white/10 bg-white/5/5 hover:bg-white/5/10 hover:border-accent/30 rounded-xl transition-all">
            <div className="p-2 bg-white/5 rounded-lg shadow-sm">
              <Book className="w-5 h-5 text-accent" />
            </div>
            <div className="text-left">
              <span className="text-sm font-bold block mb-1">User Guide</span>
              <span className="text-xs text-slate-400 font-normal">Learn the basics</span>
            </div>
          </Button>
          ...
          <Button variant="ghost" className="h-auto p-4 flex flex-col items-start gap-3 border border-white/10 bg-white/5/5 hover:bg-white/5/10 hover:border-accent/30 rounded-xl transition-all">
            ...
            <div className="text-left">
              ...
              <span className="text-xs text-slate-400 font-normal">Technical integration</span>
            </div>
          </Button>
          ...
          <Button variant="ghost" className="h-auto p-4 flex flex-col items-start gap-3 border border-white/10 bg-white/5/5 hover:bg-white/5/10 hover:border-accent/30 rounded-xl transition-all">
            ...
            <div className="text-left">
              ...
              <span className="text-xs text-slate-400 font-normal">Talk to a human</span>
            </div>
          </Button>

          <Button variant="ghost" className="h-auto p-4 flex flex-col items-start gap-3 border border-white/10 bg-white/5/5 hover:bg-white/5/10 hover:border-red-300 rounded-xl transition-all">
            <div className="p-2 bg-white/5 rounded-lg shadow-sm">
              <HelpCircle className="w-5 h-5 text-red-500" />
            </div>
            <div className="text-left">
              <span className="text-sm font-bold block mb-1 text-red-600">Report Issue</span>
              <span className="text-xs text-slate-400 font-normal">File a bug report</span>
            </div>
          </Button>
        </div>
      </Card>
