      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <Card className="p-5 border-l-4 border-l-accent">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="font-bold text-sm text-white">Active</h3>
          </div>
          <div className="text-sm text-muted-foreground mb-4">12 ongoing requirements</div>
        ...
        <Card className="p-5 border-l-4 border-l-orange-400">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="font-bold text-sm text-white">Pending Review</h3>
          </div>
          <div className="text-sm text-muted-foreground mb-4">5 awaiting approval</div>
        ...
        <Card className="p-5 border-l-4 border-l-green-500">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="font-bold text-sm text-white">Completed</h3>
          </div>
          <div className="text-sm text-muted-foreground mb-4">28 fulfilled this month</div>
          <Button variant="ghost" size="sm" className="w-full font-medium border border-white/10">View Archive</Button>
        </Card>
      </div>
