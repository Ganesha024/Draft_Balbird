  ...
  return (
    <>
      ...
      <Card className="mb-6 overflow-hidden border-0 shadow-md">
        <div className="bg-gradient-to-r from-slate-900 to-[#001524] text-white p-6 md:p-8 flex flex-col md:flex-row items-center gap-6 border-b-4 border-accent">
        ...
        <div className="lg:col-span-1 space-y-6">
          <Card className="p-5">
            ...
            <div className="space-y-4">
              <div>
                <p className="text-xs text-foreground/70 mb-1 uppercase tracking-wider font-semibold">Email</p>
                <p className="font-medium text-sm">ganesh5006pal@gmail.com</p>
              </div>
              <div>
                <p className="text-xs text-foreground/70 mb-1 uppercase tracking-wider font-semibold">Company</p>
                <p className="font-medium text-sm">Balbird Industries</p>
              </div>
              <div>
                <p className="text-xs text-foreground/70 mb-1 uppercase tracking-wider font-semibold">Role</p>
                <p className="font-medium text-sm">Execution Architect</p>
              </div>
              <div>
                <p className="text-xs text-foreground/70 mb-1 uppercase tracking-wider font-semibold">Location</p>
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card className="p-6 md:p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                <Button key={idx} variant="ghost" className="h-auto p-4 justify-start items-center gap-4 bg-background/5/5 hover:bg-background/5/10 border border-border hover:border-accent/30 transition-all rounded-xl">
          ...
          <Card className="p-6 md:p-8 border-l-4 border-l-red-500">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-between p-5 bg-red-50/50 rounded-xl border border-red-100">
              <div>
                <div className="font-bold text-sm text-foreground">Sign Out</div>
                <div className="text-xs text-foreground/70 mt-1">End your current session securely</div>
              </div>
